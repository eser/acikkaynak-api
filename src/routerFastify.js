...
function router(server) {
    ...
    server.get('/graphql', (request, reply) => fastifyContext(reply, () => actionGraphQL(request.body.query)));
    server.post('/graphql', (request, reply) => fastifyContext(reply, () => actionGraphQL(request.body.query)));
